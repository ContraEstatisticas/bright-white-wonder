...
export const CTASection = () => {
  ...
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(180deg, #ffffff 0%, #f9f0ff 60%, #ffffff 100%)',
      }}
    >
      {/* Background glows */}
      <div
        className="absolute top-0 left-0 w-64 h-64 rounded-full -translate-x-1/2 -translate-y-1/2 pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(69,65,254,0.08), transparent 70%)' }}
      />
      <div
        className="absolute bottom-0 right-0 w-96 h-96 rounded-full translate-x-1/2 translate-y-1/2 pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(254,14,131,0.06), transparent 70%)' }}
      />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Title */}
          <h2
            className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6"
