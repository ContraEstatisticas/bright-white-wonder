  ...
  return (
    <section
      ...
      style={{
        ...
        top: '0',
        zIndex: 1,
        backgroundImage: 'radial-gradient(circle farthest-side at 50% 120%, rgba(69,65,254,0.18) 0%, transparent 70%), linear-gradient(180deg, #f9f0ff 0%, #ffffff 100%)',
      }}
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(circle at 80% 50%, rgba(254,14,131,0.07), transparent 55%)',
        }}
      />
          ...
          <div className="relative">
            <div className="aspect-square max-w-md mx-auto relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className="w-full h-full rounded-full border-2 border-dashed animate-pulse-soft"
                  style={{ borderColor: 'rgba(69,65,254,0.2)' }}
                />
              </div>
              <div className="absolute inset-8 flex items-center justify-center">
                <div
                  className="w-full h-full rounded-full border-2 border-dashed"
                  style={{ borderColor: 'rgba(254,14,131,0.15)' }}
                />
              </div>
              <div
                className="absolute inset-16 flex items-center justify-center rounded-full"
                style={{ background: 'radial-gradient(circle, rgba(69,65,254,0.1), rgba(254,14,131,0.06))' }}
              />
          ...
          <div className="space-y-6">
            {features.map((feature) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-display text-lg font-semibold mb-1" style={{ letterSpacing: '-0.02em' }}>
                    {feature.title}
                  </h3>
